...
erplab_db_backup_file_path=$backup_subfolder_path/erplabdb_backup.sql
erpinventory_db_backup_file_path=$backup_subfolder_path/erpinventorydb_backup.sql
...
backup_db "mysql" $OPENMRS_DB_NAME root $MYSQL_ROOT_PASSWORD $openmrs_db_service_name $openmrs_db_backup_file_path

log_info "Taking backup for Reports Database"
backup_db "mysql" $REPORTS_DB_NAME root $MYSQL_ROOT_PASSWORD $reports_db_service_name $reports_db_backup_file_path
...
log_info "Taking backup for Odoo ERPLab Database"
backup_db "postgres" erplab $ODOO_DB_USER $ODOO_DB_PASSWORD $odoo_db_service_name $erplab_db_backup_file_path

log_info "Taking backup for Odoo ERPInventory Database"
backup_db "postgres" erpinventory $ODOO_DB_USER $ODOO_DB_PASSWORD $odoo_db_service_name $erpinventory_db_backup_file_path
...
backup_container_file_system $odoo_service_name "/var/lib/odoo" "$BACKUP_ROOT_FOLDER"
