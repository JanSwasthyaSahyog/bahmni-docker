...
erplab_db_backup_file_path=${RESTORE_ARTIFACTS_PATH}/erplabdb_backup.sql
erpinventory_db_backup_file_path=${RESTORE_ARTIFACTS_PATH}/erpinventorydb_backup.sql
...
restore_db "postgres" erplab $ODOO_DB_USER $ODOO_DB_PASSWORD $odoo_db_service_name $erplab_db_backup_file_path

restore_db "postgres" erpinventory $ODOO_DB_USER $ODOO_DB_PASSWORD $odoo_db_service_name $erpinventory_db_backup_file_path
